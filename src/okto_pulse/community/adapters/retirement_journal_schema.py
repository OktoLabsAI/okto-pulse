...
async def expand_retirement_checkpoint_schema(connection):
    ...
    if expression == "ordinal >= 0 AND ordinal <= 9":
        return
    if expression not in {"ordinal >= 0 AND ordinal <= 3", "ordinal >= 0 AND ordinal <= 5", "ordinal >= 0 AND ordinal <= 6", "ordinal >= 0 AND ordinal <= 7", "ordinal >= 0 AND ordinal <= 8"}:
        raise ValueError("retirement_checkpoint_constraint_mismatch")
