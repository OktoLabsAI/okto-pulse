        ...
        session.add_all(
            [
                ...
                ConsolidationAudit(
                    ...
                    board_id=OTHER_BOARD_ID,
                    artifact_id="card-keep",
                    artifact_type="card",
                    agent_id="agent",
                    started_at=now,
                ),
                ExactRebuildConsolidationAckJournal(
                    queue_id="exact-queue-erase",
                    board_id=BOARD_ID,
                    source="rebuild:manifest-erase",
                    reservation_lineage_id="b" * 64,
                    work_kind="consolidate",
                    artifact_type="card",
                    artifact_id="card-erase",
                    generation=0,
                    membership_source_ref="card:card-erase",
                    membership_source_version="1",
                    membership_content_hash="c" * 64,
                    audit_content_hash="a" * 64,
                    consolidation_session_id="session-erase",
                    outbox_event_id="exact-outbox-erase",
                    generation_event_id="exact-event-erase",
                    previous_materialization_generation="mg-before-erase",
                    materialization_generation="mg-after-erase",
                    node_ref_count=1,
                    node_refs_sha256="d" * 64,
                    receipt_sha256="e" * 64,
                    created_at=now,
                ),
                ExactRebuildConsolidationCompensation(
                    compensation_id="f" * 64,
                    board_id=BOARD_ID,
                    source="rebuild:manifest-erase",
                    reservation_lineage_id="b" * 64,
                    baseline_materialization_generation="mg-before-erase",
                    terminal_materialization_generation="mg-after-erase",
                    ack_count=1,
                    node_ref_count=1,
                    ack_receipts_sha256="1" * 64,
                    audit_session_ids=["session-erase"],
                    outbox_event_ids=["exact-outbox-erase"],
                    generation_event_ids=["exact-event-erase"],
                    compensated_at=now,
                    receipt_sha256="2" * 64,
                ),
                ExactRebuildConsolidationAckJournal(
                    queue_id="exact-queue-keep",
                    board_id=OTHER_BOARD_ID,
                    source="rebuild:manifest-keep",
                    reservation_lineage_id="3" * 64,
                    work_kind="consolidate",
                    artifact_type="card",
                    artifact_id="card-keep",
                    generation=0,
                    membership_source_ref="card:card-keep",
                    membership_source_version="1",
                    membership_content_hash="4" * 64,
                    audit_content_hash="0" * 64,
                    consolidation_session_id="session-keep",
                    outbox_event_id="exact-outbox-keep",
                    generation_event_id="exact-event-keep",
                    previous_materialization_generation="mg-before-keep",
                    materialization_generation="mg-after-keep",
                    node_ref_count=0,
                    node_refs_sha256="5" * 64,
                    receipt_sha256="6" * 64,
                    created_at=now,
                ),
                ExactRebuildConsolidationCompensation(
                    compensation_id="7" * 64,
                    board_id=OTHER_BOARD_ID,
                    source="rebuild:manifest-keep",
                    reservation_lineage_id="3" * 64,
                    baseline_materialization_generation="mg-before-keep",
                    terminal_materialization_generation="mg-after-keep",
                    ack_count=1,
                    node_ref_count=0,
                    ack_receipts_sha256="8" * 64,
                    audit_session_ids=["session-keep"],
                    outbox_event_ids=["exact-outbox-keep"],
                    generation_event_ids=["exact-event-keep"],
                    compensated_at=now,
                    receipt_sha256="9" * 64,
                ),
                KuzuNodeRef(
