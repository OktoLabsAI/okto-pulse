...
assert ">=0.3.0" in core_requirement and "<1.0.0" in core_requirement
console_scripts = {
...
"""
    ...
    assert origin_report["versions"] == {"community": "0.3.0", "core": "0.3.0"}
...
"""
    ...
    assert version_result.stdout.strip() == "okto-pulse 0.3.0 (okto-pulse-core 0.3.0)"
...
async def _assert_mcp_inventory(
    ...
    assert client.initialize_result.serverInfo.version == "0.3.0"
