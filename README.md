...
| MCP tools exposed by `okto-pulse serve` | 281 |
...
| `tools/list` — 281 tools (name + description + JSON schema) | ~34.5K |
...
| Current full Community->Core import inventory | `700` |
| Inventory classification | `public_contract=700`, `governed_temporary_reach_in=0` |
