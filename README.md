...
| MCP tools exposed by `okto-pulse serve` | 277 |
...
| `tools/list` — 277 tools (name + description + JSON schema) | ~34.5K |
...
| Current full Community->Core import inventory | `665` |
| Inventory classification | `public_contract=665`, `governed_temporary_reach_in=0` |
