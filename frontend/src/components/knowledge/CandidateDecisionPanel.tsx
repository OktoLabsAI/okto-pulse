...
export function CandidateDecisionPanel({
  ...
  return (
    ...
    >
      <header className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 px-5 py-4 text-slate-600 dark:border-slate-800 dark:text-slate-300">
        <div>
          <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Candidate decisions</h3>
          <p className="mt-1 text-xs">Review proposed decisions before promoting, linking or dismissing them.</p>
        </div>
        <span data-testid="candidate-decision-counts" className="text-xs">
