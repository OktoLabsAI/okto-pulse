...
import { CARD_STATUSES, STORY_STATUSES, IDEATION_STATUSES, REFINEMENT_STATUSES, SPEC_STATUSES, SPRINT_STATUSES } from '@/types';
...
describe('lineage status colors', () => {
  it('covers all current entity lifecycles with a distinct stable color per status', () => {
    const statuses = new Set([...CARD_STATUSES, ...STORY_STATUSES, ...IDEATION_STATUSES, ...REFINEMENT_STATUSES, ...SPEC_STATUSES, ...SPRINT_STATUSES]);
