...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // OktoLabs brand palette — derived from the logo gradient
        accent: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
          300: '#7dd3fc',
          400: '#38bdf8',
          500: '#0ea5e9',   // Primary cyan-blue — logo top
          600: '#0284c7',
          700: '#0369a1',
          800: '#075985',
          900: '#0c4a6e',
        ...
        violet: {
          ...
          300: '#c4b5fd',
          400: '#a78bfa',
          500: '#8b5cf6',   // Secondary violet — logo bottom
          600: '#7c3aed',
          700: '#6d28d9',
          800: '#5b21b6',
          900: '#4c1d95',
        ...
        // Refined surface palette (warmer than pure gray)
        surface: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
      ...
      boxShadow: {
        ...
        'card-dark-hover': '0 4px 12px -2px rgb(0 0 0 / 0.3), 0 2px 6px -2px rgb(0 0 0 / 0.2)',
